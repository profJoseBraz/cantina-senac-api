...
import { getAllOrderItems, getOrderItemsById, getOrderItemsByOrderId, getOrderItemsByProductId, getOrderItemsTotalById } from '../controllers/OrderItemsController.js';
...
router.get("/report", (req, res) => __awaiter(void 0, void 0, void 0, function* () { return getOrderItemsTotalById(req, res, yield createNewConnection()); }));
