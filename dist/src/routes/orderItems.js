...
import { getAllOrderItems, getOrderItemsById, getOrderItemsByCustomerName } from '../controllers/OrderItemsController.js';
...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (query.id) {
            ...
            return getOrderItemsByCustomerName(req, res, yield createNewConnection());
        }
